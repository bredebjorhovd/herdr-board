...
/// thing people are handed actually parses, without a herdr to discover.
...
/// left it while a PR waits, which is what the board did before AGE-21. Set and
/// unresolvable is not fine, and is invisible otherwise: the writeback is
